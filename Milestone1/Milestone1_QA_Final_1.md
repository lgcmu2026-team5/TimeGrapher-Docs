...
**Why these numbers**
- **Physical mm normative, px advisory** — "9 mm ≈ 48 px" holds only at ≈ 135 ppi (a 7-inch 800×480 panel); the Draft itself states both 8-inch (≈ 117 ppi → 9 mm ≈ 41 px) and 5-inch (≈ 187 ppi → ≈ 66 px), so pass/fail must not depend on the conversion. Open question recorded in C-1.
...
**측정값 근거**
- **물리 mm 규범, px 참고** — "9 mm ≈ 48 px"는 약 135 ppi(7인치 800×480 패널)에서만 성립; Draft 자체가 8인치(≈ 117 ppi → 9 mm ≈ 41 px)와 5인치(≈ 187 ppi → ≈ 66 px)를 동시에 기술하므로 pass/fail이 환산에 의존하면 안 됨. 미해결 질문은 C-1에 기록.
