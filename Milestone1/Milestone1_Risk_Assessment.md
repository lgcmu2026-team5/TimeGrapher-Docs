...
- **R-D1 — AGC 미차단·마이크 커플링 불량 → 신호 왜곡으로 전 측정 신뢰도 붕괴**
  - 품질요소: Dependability (Reliability)
...
- **R-D2 — Windows↔RPi 포팅 — 오디오 백엔드(WASAPI/ALSA) 차이; 개발은 Win·데모는 RPi라 성능 격차 노출**
...
- **R-E1 — 저해상도 터치스크린에 요약바+다중 그래프+scope strip을 가독성(글자 ≥2.9mm·터치 ≥9mm) 있게 못 담음**
  - 품질요소: Usability
