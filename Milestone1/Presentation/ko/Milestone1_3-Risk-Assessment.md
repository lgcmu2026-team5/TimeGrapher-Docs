...
R-B1 | A·C 이벤트 위치를 0.1 ms 정밀도로 못 찾아 rate·beat error·amplitude 전부 오염된다 | T | QAS-2<br>QAS-3 | **H** | **H**
...
R-E1 | 작은 화면에 요약바 + 그래프 + 스코프 스트립을 가독성 있게 다 못 담는다 | T | QAS-5 | M | M
R-E2 | 터치 정확도·인식률이 떨어질 수 있다 | T | QAS-5 | L | L
R-F1 | 3주 안에 12개 기능 + AI 전부 불가능 — 우선순위 실패 시 핵심이 빠진다 | NT | QAS-ALL | M | **H**
