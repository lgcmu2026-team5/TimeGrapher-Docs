...
| Source of Stimulus | [EN] Completed or updated sequence data<br>[KO] 완료되었거나 갱신된 sequence data |
...
### QA-04-02 Measurement Accuracy Across Positions
...
| ID | QA-04-02 |
| Quality Attribute | [EN] Accuracy<br>[KO] 정확도 |
| Source of Stimulus | [EN] Multi-position measurement sequence<br>[KO] Multi-position measurement sequence |
...
| Source of Stimulus | [EN] Measurement update<br>[KO] 측정값 갱신 |
...
| Artifact | [EN] Position and sequence result behavior<br>[KO] Position 및 sequence result 동작 |
...
| Source of Stimulus | [EN] Project enhancement request<br>[KO] 프로젝트 개선 요청 |
...
| Artifact | [EN] Position and sequence feature behavior<br>[KO] Position 및 sequence feature behavior |
...
[EN] When a reviewer asks how X or D was produced for a standard-position sequence, the result can be explained by tracing the displayed summary back to included and excluded position results.

[KO] 리뷰어가 표준 position sequence에서 X 또는 D가 어떻게 생성되었는지 질문하면, 표시된 summary를 포함 및 제외된 position result로 역추적하여 결과를 설명할 수 있다.

| Field | Description |
|---|---|
| ID | QA-04-07 |
| Quality Attribute | [EN] Testability<br>[KO] 테스트 용이성 |
| Source of Stimulus | [EN] Reviewer or user<br>[KO] 리뷰어 또는 사용자 |
| Stimulus | [EN] A reviewer or user asks how a position result, X, or D was produced.<br>[KO] 리뷰어 또는 사용자가 position result, X 또는 D가 어떻게 생성되었는지 질문한다. |
| Artifact | [EN] Position results and sequence summary<br>[KO] Position results 및 sequence summary |
