> Source: https://github.com/lgcmu2026-team5/TimeGrapher-Net/blob/a1a010f48c415a62a85ee6898eeb62bb92aaff4a/docs/ADR/ko/ADR-002.md
...
이 구조의 architecture view는 [Worker Pipeline View](../5-Architecture-Views/5-7-Worker-Pipeline-View.md)에 둔다. 이 ADR은 worker-level flow에는 Pipe-and-Filter를 적용하고, worker 내부 hot path에는 적용하지 않는 결정을 기록한다.
